<template>
  <div>
    ...
    <div  style="margin-left: 5%;margin-bottom:20px;border-style: none;text-align: left">
      <div style="margin-bottom:6px;font-size: 20px ">教学计划:</div>
      <div style="margin-bottom:6px;margin-left: 2% ">名称:     {{teachingPlanName}}</div>
      <div style="margin-bottom:6px;margin-left: 2%  ">描述信息:    {{teachingPlanDescription}}</div>
    </div>
    <div id="tab">
      ...
      <div class="zh" style="border: 1px solid #ccc;">
        <div  :is="currentDay" style="text-align: left;border-style: none">

          <div style="display: flex;flex-direction: row">
            <div style="border: none; width: 50%">
              <div style="border-style: none;">{{teachingPlan[isActive-1].teachingDate}}  教学天详情</div>
              <div style="margin-left: 4%;border-style:none;font-size: 15px" >名称:  {{teachingPlan[isActive-1].name}}</div>
              <div style="margin-left: 4%;border-style: none;font-size: 15px">描述信息    {{teachingPlan[isActive-1].description}}</div>
            </div>
<div style="border: none; width: 50%;flex-direction: column;display: flex;justify-content: center;align-items: end">
  <el-button style="width: 100px" @click="editDay"> 修改教学信息 </el-button>
  <el-button style="width: 100px" @click="attendance"> 查看考勤记录 </el-button>
        ...
        <div >
          <zyx style="border-style: none">
            ...
            <el-button @click="postHomework()" style="margin-top: 10px">
              <i class="el-icon-upload"></i>布置作业
            </el-button>
            <div v-for="(homework,index) in teachingPlan"
                 style="border-style: none">
              <div v-if="isActive==index+1" style="border-style: none">
              <div v-for="(dayhmwk,index2) in homework.dayhm" style="display: flex;flex-direction: row;width: 100%;align-items: center">
                ...
                <div style="border-style: none;width: 50%;text-align: end">
                  <el-button @click="deleteHomework(dayhmwk.homeworkId)" style="margin-top: 10px">
                    <i class="el-icon-upload"></i>删除作业
                  </el-button>
                  <el-button @click="judgeHomework(dayhmwk.homeworkId)" style="margin-top: 10px">
                    <i class="el-icon-upload"></i>批改作业
                  </el-button>
                </div>
              </div>
          ...
          <div>
            ...
            <div style="display: flex;flex-direction: row">
              ...
              >
                <div style="border-style: none"
                  ...
                  <div v-for="daymtrl in material.daymt"
                       style="border-style: none">
                    <el-link  @touchstart="gtouchstart()" @touchmove="gtouchmove()" @touchend="gtouchend(item.value)" @click="jumptoDownload(daymtrl.url)"  style="font-size: 16px;margin-left: 1%">{{daymtrl.name}}33</el-link>
                  </div>
              ...
              <div style="width: 50%;border: none">
                ...
                <el-button @click="addMT" style="margin-top: 10px">
...
// 上传文件
    onUpload (formData) {
      console.log(formData)
      axios.put('/api/v1/homework/submit/'+homeworkId,
          formData,{
        headers:{
          'Content-type' : 'multipart/form-data',
        }
