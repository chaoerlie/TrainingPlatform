    ...
    <div>
      <el-tabs v-model="activeName"  @tab-click="handleClick">
        ...
        <el-tab-pane class="zyx" label="待处理" name="first">
          ...
          >
            <el-card
              v-if="leaveRcd.progress==2&&leaveRcd.engineerStatus=='APPROVED'&&leaveRcd.teacherStatus=='WAITING'"
        ...
        <el-tab-pane class="zyx" label="已驳回" name="second">
          ...
          >
            <el-card
              v-if="leaveRcd.teacherStatus=='REJECTED'"
              class="box-card" style="width: 50%;margin-bottom: 20px">
              <div slot="header" class="clearfix">
        ...
        <el-tab-pane class="zyx" label="已通过" name="third">
          ...
          >
            <el-card
              v-if="leaveRcd.teacherStatus=='APPROVED'"
              class="box-card" style="width: 50%;margin-bottom: 20px">
              <div slot="header" class="clearfix">
...
export default {
  ...
  data() {
    return{
      ...
      leaveRecord:[
        {leaveRecordId:1,name:"zh",desc:"耍朋友",status:4,phone:18090000531,department:"软件学院",leaveTimeDay:"2022-1-2",backTimeDay:"2022-7-21",teacherStatus:"approved",engineerStatus:"approved"},
        {leaveRecordId:2,name:"zyx",desc: "耍朋友",status:2,phone:18090000531,department:"软件学院",leaveTimeDay:"2022-1-2",backTimeDay:"2022-7-21",teacherStatus: "rejected",engineerStatus: "waiting"},
        {leaveRecordId:3,name:"hz",desc: "打游戏",status:2,phone:18090000531,department:"软件学院",leaveTimeDay:"2022-1-2",backTimeDay:"2022-7-21",teacherStatus: "approved",engineerStatus: "waiting"},
        {leaveRecordId:4,name:"hys",desc:"打NBA",status: 1,phone:18090000531,department:"软件学院",leaveTimeDay:"2022-1-2",backTimeDay:"2022-7-21",teacherStatus: "waiting",engineerStatus: "waiting"},
        {leaveRecordId:5,name:"cgf",desc:"睡觉",status: 1,phone:18090000531,department:"口腔医学院",leaveTimeDay:"2022-1-1",backTimeDay:"2022-4-2",teacherStatus: "waiting",engineerStatus: "waiting"},
        {leaveRecordId:6,name:"zhw",desc: "写代码",status: 3,phone:18090000531,department:"软件学院",leaveTimeDay:"2022-1-2",backTimeDay:"2022-7-21",teacherStatus: "approved",engineerStatus: "rejected"}
      ]
    }
  },
