  ...
  <el-container class="layout-container-demo" style="height: 100%">
    ...
    <el-aside width="180px" >
      ...
      <el-scrollbar style="height: 87%">
        <el-menu >
          <el-menu-item index="1" @click="teachingPlan"><el-icon><Document /></el-icon>教学计划</el-menu-item>
          <el-menu-item index="2" @click="classInfo"><el-icon><User /></el-icon>班级管理</el-menu-item>
          <el-menu-item index="3" @click="leave"><el-icon><ChatLineRound /></el-icon>请假系统</el-menu-item>
        </el-menu>
      </el-scrollbar>
    </el-aside>
